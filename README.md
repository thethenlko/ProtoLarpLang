...
**ProtoLarpLang** is a *simple programming language* that was made without a goal to become a big programming language.
...
### Remember, every command after argument ends with keyword "OwO"
For example:
```
say Hello World OwO
...
As you might guess, it adds a delay in the code.
